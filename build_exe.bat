@echo off
title LarkEcho build tool
echo ============================================
echo    Build LarkEcho (Windows)
echo ============================================
echo.
...
echo.
echo [2/4] Building CLI (lark) ...
python tools\build.py cli
if errorlevel 1 goto err_pack

echo.
echo [3/4] Building GUI (lark-gui) ...
...
echo [4/4] Done !
echo.
echo    Output files : dist\lark.exe
echo                   dist\lark-gui.exe
echo.
pause
exit /b 0
